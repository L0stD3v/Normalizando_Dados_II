...
SELECT cliente_id, cliente_nome, cliente_endereco, cliente_telefone, cliente_email from Pedidos;

SELECT 
	cliente_endereco, 
    trim(substring_index(cliente_endereco, ",", 1)) as Rua,
	trim(substring_index(substring_index(cliente_endereco, "-", 1),',',-1)) as Numero,
    trim(substring_index(substring_index(cliente_endereco, ",", -1), '-', 2)) as Estado
FROM Cliente;
-- ---------------------------------------------------------------------------------------------

-- Tabela de Contato
CREATE TABLE Contato as
SELECT cliente_id, cliente_telefone, cliente_email from Cliente;
...
SELECT produto_id, produto_descricao, produto_categoria, preco_unitario from Pedidos;
...
SELECT produto_id, preco_unitario, quantidade, valor_item from Pedidos;
...
alter table pedidos drop column cliente_endereco;
alter table pedidos drop column cliente_telefone;
alter table pedidos drop column cliente_email;
alter table pedidos drop column produto_id;
alter table pedidos drop column produto_descricao;
alter table pedidos drop column produto_categoria;
alter table pedidos drop column preco_unitario;
alter table pedidos drop column quantidade;
alter table pedidos drop column valor_item;

alter table itens_pedido drop column produto_id;
